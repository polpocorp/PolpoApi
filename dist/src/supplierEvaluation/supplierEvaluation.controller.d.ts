...
export declare class SupplierEvaluationController {
    private readonly supplierEvaluationService;
    constructor(supplierEvaluationService: SupplierEvaluationService);
