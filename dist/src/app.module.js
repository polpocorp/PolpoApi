...
const stockMovement_module_1 = require("./stockMovement/stockMovement.module");
const price_module_1 = require("./price/price.module");
const purchaseOrder_module_1 = require("./purchaseOrder/purchaseOrder.module");
const purchaseOrderProduct_module_1 = require("./purchaseOrderProduct/purchaseOrderProduct.module");
const supplierEvaluation_module_1 = require("./supplierEvaluation/supplierEvaluation.module");
const saleItem_module_1 = require("./saleItem/saleItem.module");
const invoice_module_1 = require("./invoice/invoice.module");
const customer_module_1 = require("./customer/customer.module");
const customField_module_1 = require("./customField/customField.module");
const dynamic_objects_module_1 = require("./dynamic-objects/dynamic-objects.module");
