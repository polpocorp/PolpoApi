...
let PurchaseOrderController = class PurchaseOrderController {
    ...
    create(createPurchaseOrderDto) {
        console.log('Creating purchase order with data:', createPurchaseOrderDto);
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_dto_1.CreatePurchaseOrderDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_dto_1.UpdatePurchaseOrderDto]),
    __metadata("design:returntype", void 0)
